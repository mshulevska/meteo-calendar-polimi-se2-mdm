...
import com.polimi.meteocal.jsf.util.JsfUtil.PersistAction;
...
public class InvitationController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("InvitationCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("InvitationUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("InvitationDeleted"));
        if (!JsfUtil.isValidationFailed()) {
