...
import com.polimi.meteocal.session.CalendarFacade;
...
public class CalendarController implements Serializable {
    ...
    @EJB
    private com.polimi.meteocal.session.CalendarFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("CalendarCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("CalendarUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("CalendarDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class CalendarControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Calendar) {
                ...
                return getStringKey(o.getIdCalendar());
            } else {
