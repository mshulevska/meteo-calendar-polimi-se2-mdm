...
public class LocationController implements Serializable {
    ...
    @EJB
    private com.polimi.meteocal.session.LocationFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("LocationCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("LocationUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("LocationDeleted"));
        if (!JsfUtil.isValidationFailed()) {
